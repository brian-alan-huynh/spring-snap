...
class MongoDB:
    ...
    def add_file_tags(
        ...
        try:
            ...
            if remaining_messages > 0:
                cls._raise_kafka_message_delivery_failure("add_file_tags", remaining_messages, request)
            ...
            cls._raise_kafka_message_produce_failure("add_file_tags", e, request)

    @classmethod
    def write_file_caption(cls, s3_key: str, caption: str, request: Request) -> None:
        try:
            message = {
            ...
            if remaining_messages > 0:
                cls._raise_kafka_message_delivery_failure("write_file_caption", remaining_messages, request)
            ...
            cls._raise_kafka_message_produce_failure("write_file_caption", e, request)

    @staticmethod
    def read_file_tags_and_captions(
            user_id: int,
            request: Request
    ...
    @classmethod
    def delete_file_tags_and_captions(cls, s3_key: str, request: Request) -> None:
        try:
            message = {
            ...
            if remaining_messages > 0:
                cls._raise_kafka_message_delivery_failure("delete_file_tags_and_captions", remaining_messages, request)
            ...
            cls._raise_kafka_message_produce_failure("delete_file_tags_and_captions", e, request)
    
    @classmethod
    def delete_all_user_file_tags_and_captions(cls, user_id: int, request: Request) -> None:
        try:
            message = {
            ...
            if remaining_messages > 0:
                cls._raise_kafka_message_delivery_failure("delete_all_user_file_tags_and_captions", remaining_messages, request)
            ...
            cls._raise_kafka_message_produce_failure("delete_all_user_file_tags_and_captions", e, request)
